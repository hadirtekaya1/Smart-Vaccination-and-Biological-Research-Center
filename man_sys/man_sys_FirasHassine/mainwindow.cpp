...
//Please change the path below to the new location of patients.exe
    connect(ui->QR, &QPushButton::clicked, this, []() {
        QProcess::startDetached("C:/Users/Firas/OneDrive/Desktop/QT/Projet_Firas_Hassine/QRCode_Firas_Hassine/Patients/build/Desktop_Qt_6_7_3_MinGW_64_bit-Debug/debug/Patients.exe");
    });
    if (ui->stackedWidget->currentWidget() == ui->Home) {
        ui->goBack_5->hide();
    }
    else {
        ui->goBack_5->show();
